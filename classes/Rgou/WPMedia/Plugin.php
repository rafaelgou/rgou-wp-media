...
class Plugin {
	...
	public function __construct() {
		if ( defined( 'RGOU_WP_MEDIA_VERSION' ) ) {
			$this->version = RGOU_WP_MEDIA_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'rgou-wp-media';
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'admin_menu', $plugin_admin, 'menu_init' );
